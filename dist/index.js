...
function PhoneSlider(props) {
  ...
  var _useState2 = React.useState(fillArrayWithOriginalItems(props.items)),
    initialItems = _useState2[0];
  var _useState3 = React.useState(initialItems[4]),
    currentItem = _useState3[0],
    setCurrentItem = _useState3[1];
  var delay = (_props$delay = props.delay) != null ? _props$delay : 3000;
  var moveForward = React.useCallback(function () {
    setMovementOffset(movementOffset + 1);
  }, [movementOffset]);
  var moveBackward = React.useCallback(function () {
    setMovementOffset(movementOffset - 1);
  }, [movementOffset]);
  ...
  }, currentItem.title), React.createElement("div", {
    "data-nosnippet": 'true',
    style: {
      fontSize: '16px'
    }
...
function Slide(props) {
  ...
  var _useState4 = React.useState(props.initialItem),
    item = _useState4[0],
  ...
  }, React.createElement("div", null, React.createElement(Notch, {
...
exports.PhoneSlider = PhoneSlider;
